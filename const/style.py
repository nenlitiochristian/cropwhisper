...
ICON = {
    ...
    "diff_plus": '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#16a34a" stroke-width="2.5"><path d="M12 5v14M5 12h14"/></svg>',
    "diff_minus": '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#dc2626" stroke-width="2.5"><path d="M5 12h14"/></svg>',
    "diff_edit": '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#ea580c" stroke-width="2"><path d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z"/></svg>',
}
...
T_BORDER_G = "#bbf7d0"
T_ACCENT = "#16a34a"
T_ACCENT_HOVER = "#15803d"
T_ACCENT_LIGHT = "#22c55e"
T_ACCENT_PALE = "#dcfce7"
T_TEXT = "#111827"
T_TEXT_MUTED = "#6b7280"
T_TEXT_ACCENT = "#166534"
T_DANGER = "#dc2626"
T_WARNING = "#ea580c"
...
.gradio-container, .dark .gradio-container {{
    --body-background-fill: {T_BG} !important;
    --background-fill-primary: {T_BG} !important;
    --background-fill-secondary: {T_BG2} !important;
    --panel-background-fill: {T_BG} !important;
    --block-background-fill: {T_BG} !important;
    --input-background-fill: {T_BG} !important;
    --table-even-background-fill: {T_BG} !important;
    --table-odd-background-fill: {T_BG2} !important;
    --neutral-50: {T_BG} !important;
    --neutral-100: {T_BG2} !important;
    --neutral-200: {T_BORDER} !important;
    --neutral-300: #cbd5e1 !important;
    --body-text-color: {T_TEXT} !important;
    --block-title-text-color: {T_TEXT} !important;
    --block-label-text-color: {T_TEXT} !important;
    --input-text-color: {T_TEXT} !important;
    --body-text-color-subdued: {T_TEXT_MUTED} !important;
    --block-border-color: {T_BORDER} !important;
    --border-color-primary: {T_BORDER} !important;
    --border-color-accent: {T_ACCENT} !important;
    --color-accent: {T_ACCENT} !important;
    --color-accent-soft: {T_ACCENT_PALE} !important;
    --button-primary-background-fill: {T_ACCENT} !important;
    --button-primary-text-color: #fff !important;
    --button-secondary-background-fill: {T_BG} !important;
    --button-secondary-text-color: {T_TEXT} !important;
    --shadow-drop: none !important;
    --block-shadow: none !important;
    --slider-color: {T_ACCENT} !important;
    --loader-color: {T_ACCENT} !important;
    --checkbox-background-color-selected: {T_ACCENT} !important;
    --checkbox-border-color-selected: {T_ACCENT} !important;
    --button-cancel-background-fill: {T_BG} !important;
    --button-cancel-text-color: {T_DANGER} !important;
}}
...
textarea:focus, input[type="text"]:focus, input[type="number"]:focus {{
    ...
    box-shadow: 0 0 0 3px {T_ACCENT_PALE} !important;
}}
...
div[data-testid="gallery"] .upload-container {{
    ...
    border: 1px dashed {T_BORDER_G} !important;
    border-radius: 8px !important;
    box-shadow: none !important;
...
button:active, .gr-button:active {{
    background: {T_ACCENT_PALE} !important;
}}
...
button.primary:hover {{
    background: {T_ACCENT_HOVER} !important;
}}
...
::-webkit-scrollbar-track {{ background: {T_BG2}; border-radius: 3px; }}
::-webkit-scrollbar-thumb {{ background: #cbd5e1; border-radius: 3px; }}

button svg {{
    color: {T_ACCENT} !important;
    stroke: {T_ACCENT} !important;
}}
...
.gallery-item.selected {{
    border: 2px solid {T_ACCENT} !important;
    box-shadow: none !important;
}}
...
#soil-choice-row {{
    ...
    border: 1px solid {T_BORDER_G} !important;
    border-radius: 8px !important;
    box-shadow: none !important;
}}
